    ...
    <>
      {isDesktop ? (
          ...
          <DialogContent className="max-w-7xl w-full">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="flex justify-between items-center mt-2">
                <button
                  className="bg-orange-500 p-2 px-10 rounded-full shadow-md transition hover:bg-[#8B1D3D] text-white"
                  onClick={prevSlide}
                >
             ...
             <div className="h-[500px]">
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html:
                      techneDestinationSection[currentIndex].images[0]
                        .description,
                  }}
                />
              </div>
        ...
        <Drawer open={open} onOpenChange={setOpen}>
          ...
          <DrawerContent className="max-w-7xl w-full h-[650px] px-2">
            <DrawerHeader>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="h-[300px] mb-4">
                ...
                <div
                  className="text-lg text-gray-600 overflow-y-auto max-h-[200px] pr-2"
                  dangerouslySetInnerHTML={{
                    __html:
                      techneDestinationSection[currentIndex].images[0]
                        .description,
